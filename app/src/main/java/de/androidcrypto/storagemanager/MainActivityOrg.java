...
public class MainActivityOrg extends AppCompatActivity implements ILockableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler = new DBHandler(MainActivityOrg.this);
        ...
        entryRVAdapter = new EntryRVAdapter(entryModelFilteredArrayList, MainActivityOrg.this);
        entriesRV = findViewById(R.id.idRVEntries);

        // setting layout manager for our recycler view.
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MainActivityOrg.this, RecyclerView.VERTICAL, false);
        ...
        btnAddEntry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MainActivityOrg.this, AddEntryActivity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mImportClipboard.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(MainActivityOrg.this, DatabaseImportClipboard.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mImportFile.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(MainActivityOrg.this, DatabaseImportFile.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mExportMasterkey.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(MainActivityOrg.this, MasterkeyExportClipboard.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mExportDatabase.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(MainActivityOrg.this, DatabaseExportFile.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mAbout.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(MainActivityOrg.this, AboutActivity.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mDeleteAllEntries.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(MainActivityOrg.this);
                ...
                RelativeLayout container = new RelativeLayout(MainActivityOrg.this);
                ...
                alertDialog.setPositiveButton("löschen", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(MainActivityOrg.this, MainActivityOrg.class);
                        startActivity(i);
                    }
                });
    ...
    private void errorAndQuitAlert(String message) {
        AlertDialog alertDialog = new AlertDialog.Builder(MainActivityOrg.this).create();
    ...
    private void displayLicensesAlertDialog() {
        ...
        android.app.AlertDialog mAlertDialog = new android.app.AlertDialog.Builder(MainActivityOrg.this).create();
