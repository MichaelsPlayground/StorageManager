...
public class DatabaseExportFileEncrypted extends AppCompatActivity {
    // ## version 1.02b ##
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnExportDatabase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DBHandler dbHandler;
                dbHandler = new DBHandler(DatabaseExportFileEncrypted.this);
        ...
        btnSaveDatabaseToFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(DatabaseExportFileEncrypted.this, "Database ins Clipboard kopiert..", Toast.LENGTH_SHORT).show();
